...
<button class="glass-overlay w-8 h-8 rounded-lg shadow-md flex items-center justify-center text-on-surface hover:bg-surface-container-lowest transition-all">
...
<script>
    document.addEventListener('livewire:initialized', () => {
        ...
        // OpenStreetMap Standard Tiles (As user requested)
